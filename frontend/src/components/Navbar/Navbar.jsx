    ...
    return (
        <div className={classes.navbar}>
            ...
            <div className={classes.navbar__links}>
                ...
                <NavLink className = { navData => navData.isActive ? [classes.active, classes.navbar__link].join(' ') : classes.navbar__link } to="/admin/citymasters">Города и мастера</NavLink>
